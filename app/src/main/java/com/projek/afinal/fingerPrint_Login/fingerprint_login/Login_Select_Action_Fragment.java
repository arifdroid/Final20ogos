package com.projek.afinal.fingerPrint_Login.fingerprint_login;
...
//
                    if (!nameHere.equals("") && !nameHere.isEmpty() && nameHere != null) {
                        ...
                        //22september remove
                        ((FingerPrint_LogIn_Final_Activity) Objects.requireNonNull(getActivity())).nameUser = "anepuser2"; //

                        //((FingerPrint_LogIn_Final_Activity) getActivity()).phoneUser = phoneHere; //
                        //22september remove
                        ((FingerPrint_LogIn_Final_Activity) getActivity()).phoneUser = "+601112293291"; //

                        //((FingerPrint_LogIn_Final_Activity) getActivity()).globalAdminNameHere = adminName; //
                        //22september remove
                        ((FingerPrint_LogIn_Final_Activity) getActivity()).globalAdminNameHere = "anepadmin"; //

                        //((FingerPrint_LogIn_Final_Activity) getActivity()).globalAdminPhoneHere = adminPhone; //
                        //22september remove
                        ((FingerPrint_LogIn_Final_Activity) getActivity()).globalAdminPhoneHere = "+60184670568"; //
